...
<table id="myTable" class="table table-hover">
    ...
    <tr class="">
        <th onclick="sortTable()" style="cursor: pointer">Product 1</th>
        <th onclick="sortTable()" style="cursor: pointer">Product 2</th>
        <th onclick="sortTable()" style="cursor: pointer">Price 1</th>
        <th onclick="sortTable()" style="cursor: pointer">Price 2</th>
        <th onclick="sortTable()" style="cursor: pointer">Searched on</th>
    </tr>
    <tbody>
